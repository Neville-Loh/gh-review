...
pub fn key_to_action(
    ...
    match key.code {
        ...
        KeyCode::Char('e') => Some(Action::StartSuggestion),
        KeyCode::Char('E') => Some(Action::ExpandContext),
        ...
        KeyCode::Char('x') => Some(Action::DiscardPendingComment),
        KeyCode::Char('R') => Some(Action::ToggleResolveThread),
        KeyCode::Char('y') => Some(Action::AcceptSuggestion),
        KeyCode::Char('v') => Some(Action::StartVisualSelect),
        KeyCode::Char('u') => Some(Action::Unapprove),
